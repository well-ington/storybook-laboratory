...
const MainContainer = styled.div`
    ...
    & > header {
        background-image: linear-gradient(to bottom left, hsl(225, 60%, 35%, 0.8), hsl(255, 60%, 45%, 0.8)), url(https://picsum.photos/id/184/${window.innerWidth}/${window.innerHeight});
        height: 95vh;
        background-attachment: fixed;
